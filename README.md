# Nginx (Matomo) service for Wodby

Use Nginx (Matomo) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Nginx (Matomo) service in the Wodby catalog.

- [Nginx (Matomo) service in the Wodby catalog](https://wodby.com/services/matomo-nginx)
...
4. Reference `matomo-nginx` from your stack manifest.
